...
# Centered and styled large button
centered_button = """
<div style=\"display: flex; justify-content: center; margin-top: 30px;\">
    <button onclick=\"document.getElementById('run-analysis').click()\" 
    style=\"background-color: #2b6cb0; color: white; padding: 20px 40px; font-size: 22px; font-weight: bold; border: none; border-radius: 10px; cursor: pointer;\">
        Refractive Plan
    </button>
</div>
<form action=\"\" method=\"post\" style=\"display: none;\">
    <input type=\"submit\" id=\"run-analysis\" name=\"analyze\" />
</form>
"""

st.markdown(centered_button, unsafe_allow_html=True)

if "analyze" in st.session_state or st.button("Refractive Plan", key="hidden_button", help="Click the button above"):
